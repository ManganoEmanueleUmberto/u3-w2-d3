...
class HarryPotterCarouselServer extends Component {
  state = {
    films: "",
    isLoading: true,
  };
  fetchFilmS = () => {
    fetch("http://www.omdbapi.com/?apikey=2daf06fb&s=Harry Potter")
      .then((response) => {
        if (response.ok) {
  ...
  render() {
    return (
      <div>
        <h3 className="text-white ms-5 mt-5 mb-4 d-inline-block">Harry Potter Saga</h3>
...
export default HarryPotterCarouselServer;
